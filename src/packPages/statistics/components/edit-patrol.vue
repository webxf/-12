    ...
    <view v-if="radio2 == 0">
        ...
        <view class="btn">
			...
			<view v-for="(item,index) in baseDate.logs" :key="index">
			    ...
			    <textarea placeholder="暂无内容" :value="item.log" class="textarea"></textarea>
			</view>
			<view class="item-text" style="display:flex;margin-top:10px;align-items:center">
			   ...
			   <u-upload :fileList="fileList" :disabled="type==='view'" multiple @afterRead="upLoadAfterRead" @delete="upLoadDelete"
                            :maxCount="1" width="50" height="50" accept="image" style="margin-left:10px"></u-upload>
			</view>
			</view>
            <view class="item-text" style="display:flex">
				...
				<radio-group name="radio" class="radio">
						<label>
							<radio value="radio1" disabled="true"/><text>勾选是否全部完成</text>
						</label>
            ...
            <button style="height:30px;line-height:30px" @click="goBack">取消</button>
            </view>
			</view>
		</card>
    </view>
     <view v-if="radio2 == 1">
        <card :titleStyle="titleStyle" style="margin-left:10px;margin-top:10px;width:94%">
        ...
        <card :title="info.qymc" :titleStyle="titleStyle" style="margin-left:10px;margin-top:10px;width:94%">
         ...
         <card :title="info.qymc" :titleStyle="titleStyle" style="margin-left:10px;margin-top:10px;width:94%" v-for="(item,index) in baseDate.logs" :key="index">
